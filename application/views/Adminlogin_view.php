				...
				<div class="auth-box ">
						...
						<div class="content">
							...
							<form class="form-auth-small" action="index.html">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="log" id="user_name" value=""  placeholder="Customer Code"/>
								</div>
								<div class="form-group">
								...
								<!-- <a href="http://kritvainvestments.com/customer/index.php/Admindashboard"><button type="button" class="btn btn-primary btn-lg btn-block">LOGIN</button></a> -->
								<div class="bottom">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Customer Management System</h1>
...
var error = '';
                    ...
                    else
                    {
                       var data = {
                        ...
                        //alert(base_url+'/customer/index.php/Vendordata');
                        $.ajax({
                              type : 'post',
                              data : data,
                              url : base_url+'/customer/index.php/Vendorlogin/check',
                              success : function(data)
                              {
                                if (data == "added") 
                                {
                                    window.location.href = base_url+'/customer/index.php/Customerdata';
                                }
                                else
{
