                                 ...
                                 <select name="state_name_gst" class="state_name_gst">
                                    ...
                                    <?php
                                      foreach ($state_details as $row) { ?>
                                        <option id='<?php echo $row['state']; ?>' <?php if(isset($edit_user_details1['0'][' State_Name'])){ if($edit_user_details1['0'][' State_Name'] == $row['state_name']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['state_number']; ?>" class='cntrt_name'><?php echo $row['state_name']; ?></option>
                                    <?php }
                                    ?> 
</td>
<td>  
                          ...
                          <tr>
                              <td style="width: 465px;"><label for="contactName">Registered email address at GST Site<span class="required">*</span></label></td>
                              <td><input type="text"  id="gst_email_id" name="gst_email_id" class="email_validate"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['purchaser_email_id'])) { echo $edit_user_details1['0']['purchaser_email_id']; }?>" />
</td><td>
<input type="checkbox" value="Registered email address at GST Site" id="title_gstemail"></td>
                          </tr>
                          <tr>
                              <td style="width: 465px;"><label for="contactName">Registered mobile no. at GST Site<span class="required">*</span></label></td>
                              <td><input type="text"  id="gst_mobile_number " name="gst_mobile_number" class="gst_mobile_number"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['purchaser_email_id'])) { echo $edit_user_details1['0']['purchaser_email_id']; }?>" />
</td>
<td>
<input type="checkbox" value="Registered mobile no. at GST Site" id="title_gstmobile"></td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                <select id="gst_service_provider">
                                  <option>---Select---</option>
                                  <option <?php if(isset($edit_user_details1['0'][' service_provider_on_gst'])){ if($edit_user_details1['0'][' service_provider_on_gst'] == "India") { echo 'selected="selected"'; } } ?>>India</option>
                                  <option <?php if(isset($edit_user_details1['0'][' service_provider_on_gst'])){ if($edit_user_details1['0'][' service_provider_on_gst'] == "Out of India") { echo 'selected="selected"'; } } ?>>Out of India</option>
                                </select>
</td>
<td>
                            ...
                            <tr>
                                <td style="width: 465px;"><label for="contactName">Legal Name of Business as mentioned in PAN and GST Registration No<span class="required">*</span></label></td>
                                <td><input type="text" class="name_validate"  id="gst_name_validate" name="gst_name_validate"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['gst_name'])) { echo $edit_user_details['0']['gst_name']; }?>"/>
</td><td>
<input type="checkbox" id="title_legalname"></td>
                            </tr>
                             <tr>
...
<option value="--Select--">--Select--</option>                                        
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="gst_validate"  id="GST_number" name="GST_number"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['GST_number'])) { echo $edit_user_details1['0']['GST_number']; }?>"/><input type="checkbox" value="GST Registration Number OR Unique ID Number" id="title_gstprf"><?php if(isset($edit_user_details1['0']['gst_proof']) && $edit_user_details1['0']['gst_proof'] != ''){ ?>
                            ...
                            <tr>
                                <td style="width: 465px;"><label for="contactName">Tax Classification for Vendor<span class="required">*</span></label></td>
                                <td><input type="text"  id="tax_number" name="tax_number"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['TAX_number'])) { echo $edit_user_details1['0']['TAX_number']; }?>"/>
</td><td>
                                <input type="checkbox" value="Tax Classification for Vendor" id="title_gsttaxcls">
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 465px;"><label for="contactName">Vendor Classification for GST<span class="required">*</span></label></td>
                                <td><input type="text"  id="vendor_clasification" name="vendor_clasification"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['vendor_classification'])) { echo $edit_user_details1['0']['vendor_classification']; }?>"/>
</td><td>
<input type="checkbox" value="Vendor Classification for GST" id="title_gstvendorcls"></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                  <select name="nature_of_invoice" id="nature_of_invoice">
                                    <option>--Select--</option>
                                    <option <?php if(isset($edit_user_details1['0'][' nature_of_invoice'])){ if($edit_user_details1['0'][' nature_of_invoice'] == "Tax Invoice") { echo 'selected="selected"'; } } ?> value="Tax Invoice">Tax Invoice</option>
                                    <option <?php if(isset($edit_user_details1['0'][' nature_of_invoice'])){ if($edit_user_details1['0'][' nature_of_invoice'] == "Bill Of Supply") { echo 'selected="selected"'; } } ?> value="Bill Of Supply">Bill Of Supply</option>
                                  </select>
</td><td>
...
<input type="checkbox" value="Composition Scheme Applicable or not?" id="title_composcheme"></td>
                          ...
                          <!--   <tr>
                             ...
                             <tr>
                                <td style="width: 465px;"><label for="contactName">Revrse TAX applicable or not?<span class="required">*</span></label></td>
                                <td><input class="reverce_tax"  name="rev_tax" type="radio" value="Yes" <?php if(isset($edit_user_details1['0'][' Composition_Scheme_Applicability'] )){ if($edit_user_details1['0'][' Composition_Scheme_Applicability'] == 'Yes') { echo 'checked="checked"'; } } ?>>Yes<input type="radio" class="reverce_tax"  name="rev_tax" value="No" <?php if(isset($edit_user_details1['0'][' Composition_Scheme_Applicability'])){ if($edit_user_details1['0'][' Composition_Scheme_Applicability'] == 'No') { echo 'checked="checked"'; } } ?>>No
</td><td>
<input type="checkbox" value="Revrse TAX applicable or not?" id="title_rvrtax"></td>
                            </tr>
                            <!--  <tr>
                            ...
                            <tr>
                                <td style="width: 465px;"><label for="contactName">Excise Registration No<span class="required">*</span></label></td>
                                <td><input type="text"  id="excise_reg_no" name="excise_reg_no"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Excise_Registration'])) { echo $edit_user_details['0']['Excise_Registration']; }?>" disabled/>   
...
<input type="checkbox" value="Excise Registration No" id="title_exreg">
                            ...
                            <tr> 
                                <td style="width: 465px;"><label for="contactName">Excise Range<span class="required">*</span></label></td>
...
<input type="checkbox" value="Excise Range" id="title_exreg">
                             ...
                             <tr>
                                <td style="width: 465px;"><label for="contactName">Excise Division<span class="required">*</span></label></td>
...
<input type="checkbox" value="Excise Division" id="title_exdiv">
                            ...
                            <tr> 
                                <td style="width: 465px;"><label for="contactName">Excise Commissionerate<span class="required">*</span></label></td>
...
<input type="checkbox" value="Excise Commissionerate" id="title_excom">
                             ...
                             <tr>
                                <td style="width: 465px;"><label for="contactName">CST number<span class="required">*</span></label></td>
...
<input type="checkbox" value="CST number" id="title_cst">
                            ...
                            <tr> 
                                <td style="width: 465px;"><label for="contactName">LST number<span class="required">*</span></label></td>
...
<input type="checkbox" value="LST number" id="title_lst">                                          
                             ...
                             <tr> 
                                <td style="width: 465px;"><label for="contactName">Service Tax Reg No<span class="required">*</span></label></td>
...
<input type="checkbox" value="Service Tax Reg No" id="title_Servicetax">                                         
                             ...
                             <tr>
                                <td style="width: 465px;"><label for="contactName">Exc.Tax Ind. Vendor<span class="required">*</span></label></td>
                            ...
                            <tr>
                                <td style="width: 465px;"><label for="contactName">SSI status<span class="required">*</span></label></td>
                            ...
                            <tr> 
                                <td style="width: 465px;"><label for="contactName">CENVAT Scheme Participant<span class="required">*</span></label></td>
                                <td><input type="text"  id="CENVAT_scheme" name="CENVAT_scheme"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['CENVAT'])) { echo $edit_user_details['0']['CENVAT']; }?>" disabled/>
                                   <?php if(isset($edit_user_details1['0']['CENVAT']) && $edit_user_details1['0']['CENVAT'] != ''){ ?>
...
<input type="checkbox" value="CENVAT Scheme Participant" id="title_CENVAT">                                          
                                 ...
                                 <input type="button" class="btn btn-info" value="Next" id="tab_1" style="float: right;margin-top: 29px;"> 
        </div>
...
<table  class="table">
                                        ...
                                        <tr>
                                         ...
                                         <tr class="titleshow_edit" >
                                            ...
                                            <td><label for="contactName">Name<span class="required">*</span></label><input type="text"  id="name1_edit" name="name1_edit" class="name_validate"  value=""/> 
</td><td>
<input type="checkbox" id="title_title" value="Name"></td>
                                           <!--  <td></td>
                                        ...
                                        <td><input type="text"  id="vendor_type" name="vendor_type"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['vendor_type'])) { echo $edit_user_details['0']['vendor_type']; }?>"  disabled/></td>
                                        <td>
                                    ...
                                    <tr class="vendrdesc_edit" <?php if(isset($edit_user_details1['0']['vendor_type']) && $edit_user_details1['0']['vendor_type'] !=''){ ?> style="display: ''" <?php }else{ ?>style="display: none"<?php } ?>>
                                        <td><label for="contactName">Type(Nature) of Vendor<span class="required">*</span></label></td>
                                        <td><input type="text"  id="vendor_type" name="vendor_type"  value=""  disabled/></td>
                                        <td>
...
<table  class="table">
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">State Name<span class="required">*</span></label></td>
                                        <td>
                                           <select name="state_name" class="state_name_chk">
                                              ...
                                              <?php }
                                              ?>    
                                           </select> <input type="text"  id="state_name_code" name="state_name_code"  value=""  disabled/></td>
                                         <td></td>
                                    </tr>
                                    <tr class="statename_edit" <?php if(isset($edit_user_details1['0']['State_Name']) && $edit_user_details1['0']['State_Name'] != ''){ ?> style="display: ''" <?php }else{ ?>style="display: none"<?php } ?>>
                                        <td style="width: 264px;"><label for="contactName">State Name Edit<span class="required">*</span></label></td>
                                        <td>
                                        <select name="state_name" class="state_name_edit_chk">
                                          <option>---Select---</option>
                                              ...
                                              <?php }
                                              ?>  
                                          </select> <input type="text"  id="state_name_code_edit" name="state_name_code"  value=""  disabled/>
</td><td>
<input type="checkbox" id="title_statename" value="State Name"></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 264px;"><label for="email">House Number<span class="required">*</span></label></td>
...
<input type="checkbox" id="title_housenum" value="House Number">
                                     ...
                                     <tr>
                                        <td style="width: 264px;"><label for="contactName">Street<span class="required">*</span></label></td>
...
<input type="checkbox" value="Street" id="title_street">
                                    ...
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">Street 2<span class="required">*</span></label></td>
...
<input type="checkbox" value="Street 2" id="title_street2">
                                    ...
                                    <tr>
                                    <td style="width: 264px;"><label for="email">Street 3<span class="required">*</span></label></td>
...
<input type="checkbox" value="Street 3" id="title_street3">
                                ...
                                <tr>
                                    <td style="width: 264px;"><label for="contactName">Street 4<span class="required">*</span></label></td>
...
<input type="checkbox" value="Street 4" id="title_street4">
                                ...
                                <tr>
                                    <td style="width: 264px;"><label for="contactName">Street 5<span class="required">*</span></label></td>
...
<input type="checkbox" value="Street 5" id="title_street5">
                                ...
                                <tr>
                                    <td style="width: 264px;"><label for="contactName">Country Key<span class="required">*</span></label></td>
                                 ...
                                 <tr class="countrykey_edit" <?php if(isset($edit_user_details1['0']['Country_Key']) && $edit_user_details1['0']['Country_Key'] != ''){ ?> style="display: ''" <?php }else{ ?>style="display: none"<?php } ?>>
                                    ...
                                    <td class="country_value_edit">
                                       <select id="countrykey_now">
                                           <?php
                                          foreach ($country_details as $row) { ?>
                                            <option id='<?php echo $row['country_name']; ?>' <?php if(isset($edit_user_details1['0'][' country_code'])){ if($edit_user_details1['0'][' country_code'] == $row['country_code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['country_code']; ?>" class='cntrt_name'><?php echo $row['country_name']; ?></option>
                                        <?php }
                                        ?>    
                                       </select> </td><td>
                                    ...
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">City<span class="required">*</span></label></td>
...
<input type="checkbox" id="title_city">
                                    ...
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">District<span class="required">*</span></label></td>
...
<input type="checkbox" id="title_district">
                                    ...
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">Postal Code<span class="required">*</span></label></td>
                                        ...
                                        <?php if(isset($edit_user_details1['0']['Postal_Code']) && $edit_user_details1['0']['Postal_Code'] != ''){ ?>
                                          <input type="text" name="house_number" id="house_number" value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['Postal_Code'])) { echo $edit_user_details1['0']['Postal_Code']; }?>" class="required requiredField email" disabled/>
</td><td>
<input type="checkbox" value="Postal Code" id="title_postalcode">
                                    <?php } ?></td>
                                    </tr>
                                    <tr>                                        
                                        <td style="width: 264px;"><label for="contactName">Telephone 1<span class="required">*</span></label></td>
...
<input type="checkbox" value="Telephone 1" id="title_tele1">
                                    <?php } ?></td>
                                     ...
                                     <tr>
                                        <td style="width: 264px;"><label for="contactName">Telephone 2<span class="required">*</span></label></td>
...
<input type="checkbox" value="Telephone 2" id="title_tele2">
                                    ...
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">Fax Number<span class="required">*</span></label></td>
...
<input type="checkbox" value="Fax Number" id="title_faxnum">
                                    <?php } ?></td>
                                     ...
                                     <tr>
                                        <td style="width: 264px;"><label for="contactName">E-Mail Address<span class="required">*</span></label></td>
...
<input type="checkbox" value="Email ID" id="title_email">
                                    <?php } ?></td>
                                     ...
                                     <tr>
                                        <td style="width: 264px;"><label for="contactName">Permanent account number<span class="required">*</span></label></td>
 ...
 <table  class="table">
                             <tr>
                                <td style="width: 264px;"><label for="contactName">VAT Registration No<span class="required">*</span></label></td>
                                <td><input type="text"  id="vat_reg" name="vat_reg"  value="" disabled/></td>
                            </tr>  
                            <tr>
                                <td style="width: 264px;"><label for="email">Industry<span class="required">*</span></label></td>
                                 <td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Reconciliation Account<span class="required">*</span></label></td>
                                 <td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Planning group<span class="required">*</span></label></td>
                                 <td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Payment methods<span class="required">*</span></label></td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Check Double Invoice<span class="required">*</span></label></td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Previous Account no.<span class="required">*</span></label></td>
                            ...
                            <tr> 
                                <td style="width: 264px;"><label for="contactName">Terms of Payment<span class="required">*</span></label></td>
                             ...
                             <tr>
                                <td style="width: 264px;"><label for="contactName">Currency<span class="required">*</span></label></td>
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">GR-Based Invoice Verification<span class="required">*</span></label></td>
                            ...
                            <tr> 
                                <td style="width: 264px;"><label for="contactName">Service-Based Invoice Verification<span class="required">*</span></label></td>
                             ...
                             <tr>
                                <td style="width: 264px;"><label for="contactName">Incoterms<span class="required">*</span></label></td>
                            ...
                            <tr> 
                                <td style="width: 264px;"><label for="contactName">Incoterms (Part 2)<span class="required">*</span></label></td>
                        ...
                        <button type="button" class="btn btn-primary confirm_form" style="background-color: rgb(9, 185, 197);">Confirm</button> <button type="button" class="btn btn-primary reject_form" style="float: right;background-color: rgba(255, 7, 7, 0.59);">Modify</button>
        </div>
    </div>
</div>
</div>
    ...
    $(function(){
      $("body").on('click','.reject_form',function(){ 
        ...
        $("input:checked").map(function () { 
          if(field_list == '')
          {
            field_list = '<tr><td>'+i+'</td><td>'+$(this).attr('value')+'</td><td><input type="text" style="width: 399px;" class="remrk" id="remark_'+i+'"></td></tr>';
          }
          else
          {
            field_list = field_list+'<tr><td>'+i+'</td><td>'+$(this).attr('value')+'</td><td><input type="text" style="width: 399px;" class="remrk" id="remark_'+i+'"></td></tr>';
          }
          i++;
            ...
            for (var j = 1; j < i; j++) {
              ...
              else
              {
                  ...
                  else
                  {
                   ...
                   if (points_value == '') 
                  {
                    points_value = $("#remark_"+j).attr('value');
                  }
                  else
                  {
                    points_value = points_value+'!'+$("#remark_"+j).attr('value');
                  }
              }
            } 
            if (error != '') 
