            ...
            <div class="grid_24">
                <div class="grid_16 alpha" >
                    <div class="content-bar" style="margin-top: 0px"> 
                        <h4 class="page-title" style="font-family: "Open Sans",sans-serif;">Customer Details (<?php if(isset($edit_user_details['0']['Name'])) { echo $edit_user_details['0']['Name']; } ?>)</h4>
...
<br><lable>(Note : Only jpg,jpeg,pdf,png,docx files are allowed)</lable></td>
                                ...
                                <div id="show_capable" style="display: none"><span style="cursor: pointer;"><lable style='color: rgb(2, 183, 195);'><a href="<?php echo base_url(); ?>CMS_Declaration.docx" download="CMS_Declaration.docx">Download Declaration Form</a> </lable></span></div>
...
<span class="required">*</span> <i class="fa fa-question-circle class_tip" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Applicable or not"></i>
                          ...
                          <tr id="gst2" <?php if(isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                              ...
                              <td><input type="text" style="width: 273px;" id="gst_email_id" name="gst_email_id" class="email_validate"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['email_on_gst'])) { echo $edit_user_details1['0']['email_on_gst']; }?>" maxlength="50"/></td>
                          </tr>
       ...
       <tr id="gst41" <?php if(isset($edit_user_details1['0']['service_provider']) && isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                          ...
                          <tr id="gst4" <?php if(isset($edit_user_details1['0']['service_provider']) && $edit_user_details1['0']['service_provider'] == 'Yes' && isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                              <td><label for="contactName">Service Provider from India or Out Side India<i class="fa fa-question-circle class_tip" aria-hidden="true" data-toggle="tooltip" data-placement="right" title='Sec 2(17) of IGST: “location of the recipient of services” means:
...
<tr id="gst19" <?php if(isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: '';width: 273px;"<?php } else { ?>style="display: none;width: 273px;"<?php } ?>>
        ...
        <tr id="gst20" <?php if(isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: '';width: 273px;"<?php } else { ?>style="display: none;width: 273px;"<?php } ?>>
                             ...
                             <tr id="gst6" <?php if(isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                                <td><label for="contactName">Nature Of Customer Code<span class="required">*</span><i class="fa fa-question-circle class_tip" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Manufacturer: Person who manufactures goods for sale.
...
<tr id="gst91" <?php if(isset($edit_user_details1['0']['gst_applicable']) && $edit_user_details1['0']['gst_applicable'] == 'Yes') { ?>style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                               <td><label for="contactName">Revrse TAX applicable or not?<span class="required">*</span></label></td>
                                <td><input class="reverce_tax"  name="rev_tax" type="radio" value="Yes" <?php if(isset($edit_user_details1['0']['Revrse_TAX_applicablility'] )){ if($edit_user_details1['0']['Revrse_TAX_applicablility'] == 'Yes') { echo 'checked="checked"'; } } ?>>Yes<input type="radio" class="reverce_tax"  name="rev_tax" value="No" <?php if(isset($edit_user_details1['0']['Revrse_TAX_applicablility'])){ if($edit_user_details1['0']['Revrse_TAX_applicablility'] == 'No') { echo 'checked="checked"'; } } ?>>No</td>
                            </tr>
...
<td></td>
                                       ...
                                       <tr>
                                            <td style="width: 256px;"><label for="contactName">Title</label></td>
                                            <td colspan="2">
                                          ...
                                          <input type="text"  id="name2" name="name2"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Name2'])) { echo $edit_user_details['0']['Name2']; }?>"  disabled/></td><td>
                                         ...
                                         <tr class="titleshow_edit" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['Title']) && ($edit_user_details1['0']['Title'] != '' && $edit_user_details1['0']['Title'] != '0' && $edit_user_details1['0']['Title'] != '--Select--')) { ?>
...
<input type="text"  id="name2_edit" name="name2_edit" class="name_validate"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['Name2'])) { echo $edit_user_details1['0']['Name2']; }?>" maxlength="40"/></td><td>
                                    ...
                                    <tr  style="display:none" class="vendrdesc_edit" <?php if(isset($edit_user_details1['0']['vendor_type']) && ($edit_user_details1['0']['vendor_type'] != '--Select--' && $edit_user_details1['0']['vendor_type'] != '')) { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                  ...
                  <strong style="font-family: initial;">Note: This is your information as per our SAP ERP. This is view only information. Incase there are any changes please select EDIT and provide the necessary document as a proof</strong>
                         ...
                         <table  class="table" style="margin-top: 20px;">
                                ...
                                <td  style="color:green"><label for="contactName">Edit Postal Code</label></td>
                                     ...
                                     <tr>
                                        <td><label for="contactName">Region</label></td>
                                        <td>
                                           <select name="state_name" class="state_name_chk" disabled>
                                              <option>---Select---</option>
                                              <?php 
                                                foreach ($sap_state as $row) { ?>
                                                  <option id='<?php echo $row['state_code']; ?>' <?php if(isset($edit_user_details['0']['region'])){ if($edit_user_details['0']['region'] == $row['state_code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['state_code']; ?>" class='cntrt_name'><?php echo $row['state_name']; ?></option>
                                              <?php }
                                              ?>    
                                           </select> 
                                        </td>
                                    ...
                                    <tr class="statename_edit"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['State_Name']) && ($edit_user_details1['0']['State_Name'] != '' && $edit_user_details1['0']['State_Name'] != '---Select---')) { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                                        <td  style="color:green"><label for="contactName">Edit Region</label></td>
                                        <td>
...
<option  value="--Select--">--Select--</option>  
<option <?php if($edit_user_details1['0']['Country_Key'] == 'IN') { echo 'selected="selected"'; } ?> value="IN">India</option>                                          
                                       </select> 
...
<input type="button" class="btn btn-info send_to_aprv" style="float: right;" value="Final Submission" id="send_to_aprv">
 ...
 <div style="margin-top: 11px;">
   ...
   <tr>
                                ...
                                <td><input type="text"  id="eccno" style="width: 408px;" name="eccno"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['ECC_no'])) { echo $edit_user_details['0']['ECC_no']; }?>" disabled/></td>   
                                 <td><button type="button" id="eccno_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_eccno" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                            <tr class="eccno_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ECC_no']) && $edit_user_details1['0']['ECC_no'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                            <td style="color:green"><label for="contactName">Edit Ecc No</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ECC_no']) && $edit_user_details1['0']['ECC_no'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="eccno_edit" name="eccno_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ECC_no'])) { echo $edit_user_details1['0']['ECC_no']; }?>" maxlength="40" required/>
                                        <button type="button" id="save_eccno" class="btn btn-default savedetails save_eccno">Save</button>
                                    </td>                         
                            </tr>                          
                            <tr>
                            ...
                            <td style="color:green"><label for="contactName">Edit Excise Registration No</label></td>
                                        ...
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="excisereg_edit" name="excisereg_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['Excise_Registration'])) { echo $edit_user_details1['0']['Excise_Registration']; }?>" maxlength="40" required/>
                            ...
                            <tr class="excisecst_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['cst']) && $edit_user_details1['0']['cst'] != '') { ?>
                             ...
                             <td style="color:green"><label for="contactName">Edit CST number</label></td>
                                        ...
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="excisecst_edit" name="excisecst_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['cst'])) { echo $edit_user_details1['0']['cst']; }?>" maxlength="40" required/>
                            ...
                            <tr class="cenv_edit1"  style="display:none">
...
var base_url = window.location.origin;
            $.ajax({
             ...
             'datatype' : 'html',
            'data' : data,
              url : base_url+'/customer/index.php/Vendordata/del_file',
...
var base_url = window.location.origin;
            $.ajax({
             ...
             'datatype' : 'html',
            'data' : data,
              url : base_url+'/customer/index.php/Vendordata/send_approval',
              success : function(data)
...
window.setTimeout(function() {
    window.location.href = base_url+'/customer/index.php/Login';
}, 2000);
              }
            });
});
...
$("#GST_number").css('border-color','red');            
          ...
          else if(($("input[name='gst_capable']:checked").val() == "Yes" || $("input[name='provisional_num']:checked").val() == 'Yes') && $("input[name='rev_tax']:checked").val() === undefined)
          {
          ...
          {
            $(".gst_vendor_type").css('border-color','red'); 
             error = "If you are not a service provider then 'None' option for type(Nature) of customer by GST is not allow";
          }
...
form_data.append("gst_postal_code",$("#gst_postal_code").val());
                ...
                form_data.append("service_provider",$(".service_capable:checked").val());
                 form_data.append("rev_tax", $(".reverce_tax:checked").val());         
...
form_data.append("gst_declr",$('#gst_declr')[0].files[0]);
         ...
         //alert($('#gst_declr').length);
            ...
            'data' : form_data,
              url : base_url+'/customer/index.php/Vendordata/update_data1',
              success : function(data)
              {
                //alert(data);
...
form_data.append("name2_edit",$("#name2_edit").val());
  ...
  else if(sep[1] == 'vendrdesc')
  {
          ...
          {
            $(".gst_vendor_type").css('border-color','red'); 
             error = "If you are not service provider then 'None' option for type(Nature) of customer by GST is not allow";
          }
          else
          {
            error = '';
...
$(".pannumber_edit").css('border-color','red'); 
  ...
  {
      if(($(".countrykey_edit").attr('title') == 'active' && $("#countrykey_now").find(":selected").val() == "--Select--"))
      {
         $("#countrykey_now").css('border-color','red'); 
  ...
  {
      if($(".eccno_edit").attr('title') == 'active' && $(".eccno_edit").val() == "")
      {
        $(".eccno_edit").css('border-color','red'); 
         error = "Please enter valid ecc no";
      }     
      else if($(".eccno_edit").val() != "" && $(".eccno_edit").val().length>40)
{
$(".eccno_edit").css('border-color','red'); 
      ...
      else
      {
        ...
        form_data.append("eccno_edit",$(".eccno_edit").val());
      }    
  } 
...
else if($(".countrykey_edit").attr('title') == 'active' && $("#countrykey_now").find(":selected").val() == "--Select--")
      {
         $("#countrykey_now").css('border-color','red'); 
         error = "Please select country";
      }
...
if($(".eccno_edit").attr('title') == 'active' && $(".eccno_edit").val() == "")
      {
        $(".eccno_edit").css('border-color','red'); 
         error = "Please enter valid ecc no";
          ...
          else if($(".excisereg_edit").attr('title') == 'active' && $(".excisereg_edit").val() == "")
          {
            $(".excisereg_edit").css('border-color','red'); 
             error = "Please enter valid excise registration no";
          }         
