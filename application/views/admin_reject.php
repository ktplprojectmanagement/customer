...
Customer ID : <?php if(isset($Vendor_id)) { echo $Vendor_id; } ?><br> 
Customer Name : <?php if(isset($name)) { echo $name; } ?><br>
...
<br>
<a href="http://partners.vvfltd.com/customer/Login">Click here</a>
