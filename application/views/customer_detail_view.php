...
.tabs {
 ...
 <a href="<?php echo base_url(); ?>index.php/Vendorlist" style="float: right;"><input type="button" value="Back"></a>
...
<input type="checkbox" value="Composition Scheme Applicable or not?" id="title_composcheme"></td>
                          ...
                          <!--   <tr>
                           ...
                           <tr>
                                <td style="width: 465px;"><label for="contactName">Ecc No</label></td>
                                <td><input type="text"  id="excise_reg_no" name="excise_reg_no"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['ECC_no'])) { echo $edit_user_details['0']['ECC_no']; }?>" disabled/>   <br>
                                 <?php if(isset($edit_user_details1['0']['Excise_Registration']) && $edit_user_details1['0']['Excise_Registration'] != ''){ ?>
                                          <input type="text" name="house_number" id="house_number" value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ECC_no'])) { echo $edit_user_details1['0']['ECC_no']; }?>" class="required requiredField email" disabled/>
</td><td>
<input type="checkbox" value="Ecc No" id="title_exreg">
                                    <?php } ?> </td>      
                            </tr>
                            <tr>
...
<table  class="table" style="margin-top:10px">
                                        <tr>
                                            <td style="width: 150px;"><label for="contactName">Marketing Person Name</label></td>
                                        ...
                                        <tr>
                                            <td><label for="contactName">Marketing Person Email ID</label></td>
                                        ...
                                        <tr>
                                            <td><label for="contactName">Sub Marketing Person Name</label></td>
                                        ...
                                        <tr>
                                            <td><label for="contactName">Sub Marketing Person Email ID</label></td>
                                        ...
                                        <tr>
                                            <td><label for="contactName">Customer ID</label></td>
...
<tr>
                                            <td><label for="contactName">Sales Organization</label></td>
                                            <td><input type="text"  id="sale_org" name="sale_org"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Sales_Organization'])) { echo $edit_user_details['0']['Sales_Organization']; }?>"  disabled/></td>
                                        </tr>
                                        <tr>
                                            <td><label for="contactName">Distribution Channel</label></td>
                                            <td><input type="text"  id="distribution_channel" name="distribution_channel"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Distribution_Channel'])) { echo $edit_user_details['0']['Distribution_Channel']; }?>"  disabled/></td>
                                        </tr>
<tr>
                                            <td><label for="contactName">Division</label></td>
                                            <td><input type="text"  id="division" name="division"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Division'])) { echo $edit_user_details['0']['Division']; }?>"  disabled/></td>
                                        </tr>
                                        <tr>
...
<input type="text"  id="name1" name="name1"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Name2'])) { echo $edit_user_details['0']['Name2']; }?>" style="width: 281px;"  disabled/>
                                         ...
                                         <tr <?php if(isset($edit_user_details1['0']['Title']) && $edit_user_details1['0']['Title'] != '' && $edit_user_details1['0']['Title'] != '--Select--') { ?>style="display:''" <?php }else { ?>style="display:'none'"<?php } ?>>
...
<input type="text"  id="name1" name="name1"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['Name2'])) { echo $edit_user_details1['0']['Name2']; }?>" style="width: 281px;"  disabled/><input type="checkbox" value="Name" id="title_name">
                                           <!--  <td><label for="contactName">Name2<span class="required">*</span></label></td>
                                            <td><input type="text"  id="name2" name="name2"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Name2'])) { echo $edit_user_details['0']['Name2']; }?>"  disabled/></td> -->
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text"  id="pan_number" name="pan_number"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['pan'])) { echo $edit_user_details['0']['pan']; }?>" disabled/>
                                         <?php if(isset($edit_user_details1['0']['pan']) && $edit_user_details1['0']['pan'] != ''){ ?>
                                          <input type="text" name="house_number" id="house_number" value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['pan'])) { echo $edit_user_details1['0']['pan']; }?>" class="required requiredField email" disabled/>
                                    <?php } ?></td>
                                     <?php if(isset($edit_user_details1['0']['pan_proof']) && $edit_user_details1['0']['pan_proof'] != ''){ ?>
                                        <td><a href="<?php echo base_url(); ?>proof/pan/<?php echo $edit_user_details1['0']['pan_proof']; ?>" target="_blank"><span style="cursor: pointer;"><lable style='color: rgb(2, 183, 195);'><u>Open Document</u> </lable></span></a><input type="checkbox" value="Permanent Account Number(PAN)" id="title_name"></td>
                                        <?php } ?>
                                    </tr>  
...
<table  class="table" style="margin-top: 10px;">
                                    <tr>
                                        <td style="width: 264px;"><label for="contactName">Region</label></td>
                                        <td>
                                    ...
                                    <tr class="statename_edit" <?php if(isset($edit_user_details1['0']['state_code']) && $edit_user_details1['0']['state_code'] != '0'){ ?> style="display: ''" <?php }else{ ?>style="display: none"<?php } ?>>
                                        <td style="width: 264px;"><label for="contactName">Edit Region</label></td>
                                        <td>
...
<input type="checkbox" value="Street 5" id="title_street5">
                                ...
                                <tr>
                                   ...
                                   <!--  <td><input type="text"  id="country_key" name="country_key"  value=""  disabled/></td>   -->
                                    ...
                                    <td>
                                       <select id="countrykey_prev" disabled>
                                           <option <?php echo 'selected="selected"'; ?> value="IN">India</option>
                                       </select> 
                                    </td>  
                                     <td></td>                              
                                 ...
                                 <tr class="countrykey_edit" <?php if(isset($edit_user_details1['0']['Country_Key']) && $edit_user_details1['0']['Country_Key'] != ''){ ?> style="display: ''" <?php }else{ ?>style="display: none"<?php } ?>>
                                    ...
                                    <td class="country_value_edit">
                                       <select id="countrykey_now" disabled>
                                          <option <?php echo 'selected="selected"'; ?> value="IN">India</option>
                                       </select> </td><td>
...
<input type="checkbox" id="title_district" name="District">
                                    <?php } ?></td>
                                    </tr>
                                    <tr>
 ...
 <table  class="table">
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="email">Industry</label></td>
                                 <td>
                                   <select name="industry" id="industry" disabled>
                                    <option>---Select---</option>
                                      <?php
                            ...
                            <tr>
                                <td style="width: 264px;"><label for="contactName">Reconciliation Account</label></td>
                                 <td>
                                   <select name="recon_acc" id="recon_acc" disabled>
                                    <option>---Select---</option>
                                      <?php
...
<tr>
 ...
 <tr> 
                                <td><label for="contactName">Customer group</label></td>
                                <td><input type="text"  id="cust_grp" name="cust_grp"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Customergroup'])) { echo $edit_user_details['0']['Customergroup']; }?>" disabled/></td>
                            </tr>
<tr> 
                                <td><label for="contactName">Customer group 1</label></td>
                                <td><input type="text"  id="cust_grp1" name="cust_grp1"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Customer_group1'])) { echo $edit_user_details['0']['Customer_group1']; }?>" disabled/></td>
                            </tr>
                             <tr> 
                                <td><label for="contactName">FI - Terms Of Payment</label></td>
                                <td><input type="text"  id="fi_term" name="fi_term"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['FI_Terms_Of_Payment'])) { echo $edit_user_details['0']['FI_Terms_Of_Payment']; }?>" disabled/></td>
                            </tr>
                             <tr> 
                                <td><label for="contactName">Sales Terms Of Payment</label></td>
                                <td><input type="text"  id="sale_paymnt" name="sale_paymnt"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Sales_Terms_Of_Payment'])) { echo $edit_user_details['0']['Sales_Terms_Of_Payment']; }?>" disabled/></td>
                            </tr>
<tr> 
                                <td><label for="contactName">ABC classification</label></td>
                                <td><input type="text"  id="abc_classification" name="currency"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['ABC_classification'])) { echo $edit_user_details['0']['ABC_classification']; }?>" disabled/></td>
                            </tr>
<tr> 
                                <td><label for="contactName">Order probability</label></td>
                                <td><input type="text"  id="order_prob" name="order_prob"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['order_prob'])) { echo $edit_user_details['0']['order_prob']; }?>" disabled/></td>
                            </tr>
                             <tr> 
                                <td><label for="contactName">Clerk's internet address</label></td>
                                <td><input type="text"  id="order_prob" name="order_prob"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['clrk_internet_addr'])) { echo $edit_user_details['0']['clrk_internet_addr']; }?>" disabled/></td>
                            </tr>
<tr>
                                <td><label for="contactName">Cust.pric.procedure</label></td>
                                <td><input type="text"  id="cust_price_procd" name="cust_price_procd"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['cust_price'])) { echo $edit_user_details['0']['cust_price']; }?>" disabled/></td>                            
                            </tr>
<tr>
                                <td><label for="contactName">Price List</label></td>
                                <td>
                                  <select name="price_list" id="price_list" disabled>
                                   <option>---Select---</option>
                                      <?php
                                        foreach ($price_grp as $row) { ?>
                                          <option id='<?php echo $row['code']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['price_list'] == $row['code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
                                      ?>  
                                  </select>
                                </td>                            
 ...
 <tr>
                                <td><label for="contactName">Statistics group</label></td>
                                <td><input type="text"  id="statistic_grp" name="statistic_grp"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['statistic_grp'])) { echo $edit_user_details['0']['statistic_grp']; }?>" disabled/></td>                            
                            </tr>
<tr>
                                <td><label for="contactName">Part.dlv./item</label></td>
                                <td><input type="text"  id="part_div_item" name="part_div_item"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['part_div'])) { echo $edit_user_details['0']['part_div']; }?>" disabled/></td>                            
                            </tr>
                            <tr>
                                <td><label for="contactName">Delivering Plant</label></td>
                                <td><input type="text"  id="del_plant" name="del_plant"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['del_plant'])) { echo $edit_user_details['0']['del_plant']; }?>" disabled/></td>                            
                            </tr>
<tr>
                                <td><label for="contactName">Order Combination</label></td>
                                <td><input type="text"  id="order_combinaton" name="order_combinaton"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Order_Combination'])) { echo $edit_user_details['0']['Order_Combination']; }?>" disabled/></td>                            
                            </tr>
                             <tr>
                                <td><label for="contactName">Shipping Conditions</label></td>
                                <td><input type="text"  id="shipping_cond" name="shipping_cond"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Shipping_Conditions'])) { echo $edit_user_details['0']['Shipping_Conditions']; }?>" disabled/></td>                            
                            </tr>
<tr>
                                <td><label for="contactName">Price group</label></td>
                                <td>
                                  <select name="price_grp" id="price_grp" disabled>
                                   <option>---Select---</option>
                                      <?php
                                        foreach ($price_grp as $row) { ?>
                                          <option id='<?php echo $row['code']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['price_grp'] == $row['code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
                                      ?>  
                                  </select>
                                </td>                            
                             ...
                             <tr>
                                <td><label for="contactName">Sales Office</label></td>
                                <td>
                                  <select name="sales_office" id="sales_office" disabled>
                                   <option>---Select---</option>
                                      <?php
                                        foreach ($Sales_Office_Code as $row) { ?>
                                          <option id='<?php echo $row['code']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['Sales_Office'] == $row['code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
                                      ?>  
                                  </select>
                                </td>                            
                             ...
                             <tr>
                                <td><label for="contactName">Sales Group</label></td>
                                <td>
                                  <select name="sales_grp" id="sales_grp" disabled>
                                   <option>---Select---</option>
                                      <?php
                                        foreach ($Sales_Group as $row) { ?>
                                          <option id='<?php echo $row['code']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['Sales_Group'] == $row['code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
                                      ?>  
                                  </select>
                                </td>                            
                             ...
                             <tr>
                                <td><label for="contactName">Sales district</label></td>
                                <td>
                                  <select name="sales_dist" id="sales_dist" disabled>
                                   <option>---Select---</option>
                                      <?php
                                        foreach ($Sales_District as $row) { ?>
                                          <option id='<?php echo $row['code']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['Sales_district'] == $row['code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
                                      ?>  
                                  </select>
                                </td>                            
...
<tr>
                                    <td><label for="contactName">Language Key</label></td>
                                   <!--  <td><input type="text"  id="country_key" name="country_key"  value=""  disabled/></td>   -->
                                    
                                    <td>
                                       <select id="lanquage_prev" disabled>
                                           <?php
                                          foreach ($country_details as $row) { ?>
                                            <option id='<?php echo $row['country_name']; ?>' <?php if(isset($edit_user_details)){ if($edit_user_details['0']['language_key'] == $row['country_name']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['country_code']; ?>" class='cntrt_name'><?php echo $row['country_name']; ?></option>
                                        <?php }
                                        ?>    
                                       </select> 
                                    </td>  
                                     <td><input type="checkbox" id="title_langkey" value="Country Key"></td>                              
                                </tr>
<tr class="lang_edit" style="display: none">
                                    <td><label for="contactName">Edit Language Key</label></td>
                                    <!-- <td><input type="text"  id="country_key_edit" name="country_key"  value=""  disabled/></td>  -->
                                    <td class="lang_value_edit">
                                       <select id="lanquage_now" disabled>
                                           <?php
                                          foreach ($country_details as $row) { ?>
                                            <option id='<?php echo $row['country_name']; ?>' <?php if(isset($edit_user_details1)){ if($edit_user_details1['0']['language_key'] == $row['country_name']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['country_code']; ?>" class='cntrt_name'><?php echo $row['country_name']; ?></option>
                                        <?php }
                                        ?>    
                                       </select> 
                                    </td>                            
...
<tr>
                                    <td><label for="contactName">Transportation zone</label></td>
                                    <td><input type="text"  id="transportasionzone" name="transportasionzone"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['transportation_zone'])) { echo $edit_user_details['0']['transportation_zone']; }?>"  disabled/></td>
                            ...
                            <tr> 
                                <td><label for="contactName">Cust.Acct.Assg.Group</label></td>
                                <td><input type="text"  id="cust_acc_grp" name="cust_acc_grp"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['cust_acct'])) { echo $edit_user_details['0']['cust_acct']; }?>" disabled/></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                                <td><label for="contactName">Max.Part.Deliveries</label></td>
                                <td><input type="text"  id="part_delivery" name="part_delivery"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['max_part'])) { echo $edit_user_details['0']['max_part']; }?>" disabled/></td>                            
                            </tr>
                          <tr>
                                <td style="width: 264px;"><label for="contactName">Planning group</label></td>
                                 <td>
                                   <select name="planning_grp" id="planning_grp" disabled>
                                   <option>---Select---</option>
                                      <?php
if(isset($planning_group) && count($planning_group)>0)
{
                                        foreach ($planning_group as $row) { ?>
                                          <option id='<?php echo $row['planning_grp_code']; ?>' <?php if(isset($edit_user_details)){ if(isset($edit_user_details['0']['Planning_group']) && $edit_user_details['0']['Planning_group'] == $row['planning_grp_code']) { echo 'selected="selected"'; } } ?> value="<?php echo $row['planning_grp_code']; ?>" class='cntrt_name'><?php echo $row['description']; ?></option>
                                      <?php }
}
                                      ?>  
                                  </select>
...
<tr> 
                                <td style="width: 264px;"><label for="contactName">Exc.Tax Ind. Custom.</label></td>
                                <td><input type="text"  id="Incoterms2" name="Incoterms2"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['Exc.Tax'])) { echo $edit_user_details['0']['Exc.Tax']; }?>" disabled/></td>
                            </tr>
                        </table>
          ...
          $("body").on('click','#reject_details',function(){
            ...
            else
            {
              ...
              $.ajax({
                  type : 'post',
                  data : data,
                  url : base_url+'/customer/index.php/Vendordata/update_remark',
         ...
         $("body").on('click','#confirm_details',function(){
          ...
          var base_url = window.location.origin;
              ...
              $.ajax({
                  type : 'post',
                  data : data,
                  url : base_url+'/customer/index.php/Vendordata/update_remark_aprv1',
                  success : function(data)
                  {
                      jQuery("#confirm_form").modal('hide');
                      $("#purch_based_vendor").html(data);
