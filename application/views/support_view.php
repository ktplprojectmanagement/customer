...
<?php
if(isset($edit_user_details['0']['Vendor_id'])) {
$this->session->set_userdata('vendor_id',$edit_user_details['0']['Vendor_id']);
}
?>
            <div class="row">
                <div class="col-md-6">
<div class="form-group">                             
                            ...
                            <input class="form-control" id="name" type="text" value="<?php if(isset($edit_user_details['0']['Name'])) { echo $edit_user_details['0']['Name']; }?>" disabled="" />
                        </div> 
                        <div class="form-group">                             
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-md-6">
<a href="<?php echo base_url(); ?>index.php/Customerdata"><button type="button" class="btn btn-default" style="float: left;">
                            Back
                        </button></a>                     
...
$("#success_msg").css('display','');
 $("#success_msg").text('successfully submitted your query to vvf GST support team.');
                ...
                $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : data,
                      url : base_url+'/customer/index.php/Support/send_mail',
                      success : function(data)
                      {
 $("#success_msg").css('display','');
 $("#success_msg").text('successfully submitted your query to support team.');
setTimeout(function () {
   window.location.href= base_url+'/customer/index.php/Support/'; // the redirect goes here
