...
$data['sap_state'] = $this->common_model->get_all_data('sap_state');
		...
		$data['status_flag'] = 1;
		$data['table_name'] = 'customer_details';
		$query = "where Vendor_id = ?";
		$data['edit_user_details'] = $this->common_model->fetch_data('customer_details',$query,$this->session->userdata('vendor_id'));

		$data['table_name'] = 'customer_details_update';
		$query = "where Vendor_id = ?";
		$data['edit_user_details1'] = $this->common_model->fetch_data('customer_details_update',$query,$this->session->userdata('vendor_id'));
